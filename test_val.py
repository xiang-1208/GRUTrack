...
detection_path = val_path+"/VoxelNeXt-Detection-FlipTest.json"
detection_path = "/home/wxx/vel/Poly-MOT/data/detector/centerPoint/infos_val_10sweeps_withvelo_filter_True.json"
...
# detection_path = "/home/wxx/VoxelNeXt/out/val/data.json"
# first_token_path = "/home/wxx/VoxelNeXt/out/val/first.json"
# final_token_path = "/home/wxx/VoxelNeXt/out/val/final.json"
# token_path = "/home/wxx/VoxelNeXt/out/val/tokens.json"
...
# parser.add_argument('--detection_path', type=str, default='/home/wxx/Poly-MOT/infos_val_10sweeps_withvelo_filter_True.json')
# parser.add_argument('--first_token_path', type=str, default='data/utils/first_token_table/trainval/nusc_first_token.json')
# parser.add_argument('--final_token_path', type=str, default='data/utils/final_token_table/trainval/nusc_final_token.json')
# parser.add_argument('--token_path', type=str, default='/home/wxx/Poly-MOT/data/utils/token_table/trainval/nusc_trainval_token.json')
...
seq_token = load_file(args.token_path) #[0:10]
flat_list = []
...
def main(result_path, token, process, nusc_loader,nusc_path):
    ...
    for frame_data in tqdm(nusc_loader, desc='Running', total=len(nusc_loader) // process, position=token):
        ...
        view(num,pred_boxes=sample_results,sample_token=sample_token)
