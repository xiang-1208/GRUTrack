...
FIRST_TOKEN_ROOT_PATH = '../utils/final_token_table/'
...
def extract_first_token(dataset_path, detector_path, dataset_name='NuScenes', dataset_version='trainval'):
    ...
    if dataset_name == 'NuScenes':
        ...
        FIRST_TOKEN_PATH = FIRST_TOKEN_ROOT_PATH + dataset_version + "/nusc_final_" + dataset_version +"_token.json"
...
if __name__ == "__main__":
    ...
    #     detector_path='/home/wxx/Poly-MOT/infos_train_10sweeps_withvelo_filter_True.json',
